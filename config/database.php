    ...
    */
    ...
    'connections' => [
        ...
        'server25' => [
            'driver' => 'mysql',
            'url' => env('MCB_URL'),
            'host' => env('MCB_HOST', '127.0.0.1'),
            'port' => env('MCB_PORT', '3306'),
            'database' => env('MCB_DATABASE', 'laravel'),
            'username' => env('MCB_USERNAME', 'root'),
            'password' => env('MCB_PASSWORD', ''),
            'unix_socket' => env('MCB_SOCKET', ''),
            'charset' => env('MCB_CHARSET', 'utf8mb4'),
            'collation' => env('MCB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
