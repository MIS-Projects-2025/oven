    ...
    */
    ...
    'connections' => [
        ...
        'bake' => [
            ...
            'port' => env('BDB_PORT', '3306'),
            'database' => env('BDB_DATABASE', 'laravel'),
            'username' => env('BDB_USERNAME', 'root'),
            'password' => env('BDB_PASSWORD', ''),
            'unix_socket' => env('BDB_SOCKET', ''),
            'charset' => env('BDB_CHARSET', 'utf8mb4'),
            'collation' => env('BDB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
