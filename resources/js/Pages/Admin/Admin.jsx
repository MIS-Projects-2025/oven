    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="flex items-center justify-between mb-4">
                <h1 className="text-2xl font-bold text-blue-500 animate-pulse"><i className="fa-solid fa-users-gear mr-2"></i> Admin List</h1>
                    <button
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-3 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="px-4 py-2 rounded-lg bg-gray-600 text-white hover:bg-gray-700 text-sm font-medium transition-all duration-200"
          >
