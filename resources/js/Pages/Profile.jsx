...
export default function Profile({ profile, errors }) {
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="max-w-5xl mx-auto p-6 space-y-8">
                {/* ================= HEADER ================= */}
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 via-indigo-500 to-blue-500 p-8 text-white shadow-xl">
                ...
                <div className="rounded-3xl bg-white shadow-xl border p-6 space-y-6">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-semibold transition ${
                                passwordForm
                                    ...
                                    : "bg-gray-500 text-white hover:bg-indigo-600"
                            }`}
                        >
                    ...
                    {passwordForm && (
                        <div className="space-y-5">
                            <div className="p-4 rounded-xl bg-gray-50 border border-blue-300 text-sm text-blue-800">
  ...
  className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-400 to-blue-500 text-white font-bold shadow-lg hover:scale-[1.01] transition flex items-center justify-center gap-2"
>
  <IconKey size={20} />
  Update Password
</button>
...
function InfoCard({ label, value }) {
    return (
        <div className="rounded-2xl bg-white shadow-lg border p-5 hover:shadow-xl transition">
            ...
            <p className="mt-1 text-lg font-bold text-gray-800 break-words">
                {value}
            </p>
        </div>
    );
