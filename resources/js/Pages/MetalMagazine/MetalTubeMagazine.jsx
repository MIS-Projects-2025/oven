...
export default function MetalTubeMagazine({ tableData, tableFilters, emp_data, packages }) {
...
const dataWithAction = tableData.data.map((r) => ({
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="flex items-center justify-between mb-4">
                <h1 className="text-2xl font-bold text-stone-500"><i className="fa-solid fa-users-gear mr-2"></i> Cleaning Logsheet of Magazine</h1>
                    <button
                        ...
                        className="text-blue-600 border-blue-600 btn hover:bg-gray-600 hover:text-white"
            ...
            <DataTable
                ...
                routeName={route("cleaning.logsheet.index")}
                    ...
                    <div className="relative ml-auto w-full max-w-xl h-full bg-white shadow-xl overflow-y-auto animate-slide-in">
                        ...
                        <div className="p-6 border-b flex justify-between items-center bg-gray-100">
                            <h2 className="text-lg font-semibold text-blue-600">
                                <i className="fas fa-folder-plus"></i> New Cleaning Metal Logsheet
                            </h2>
                            <button
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-4">
                             ...
                             <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    type="text"
                                    name="date_shift"
                                    value={form.date_shift}
                                    onChange={handleChange}
                                    className="w-full border-gray-500 rounded-md p-2 bg-gray-50"
                                    readOnly
                                    />
                                </div>
                                {/* Package */}
                            ...
                            <div>
                                <label className="block text-xl font-medium text-indigo-600">
                                Metal
                            </label>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                            ...
                            <div>
                                ...
                                onChange={handleChange} 
                                className="w-full border rounded-md p-2 text-gray-500 bg-gray-50"
                                readOnly 
                                />
                            </div>
    ...
    <div>
        ...
        <input
            type="text"
            value={selectedSetup.performed_by || "-"}
            className="text-stone-600 border-none font-semibold"
            readOnly
        />
    </div>
    ...
    <div>
        ...
        <input
            ...
            value={
                ...
                ? new Date(selectedSetup.date_verify).toLocaleDateString("en-US")
                : "-"
                }
            className="text-stone-600 border-none font-semibold w-full"
            readOnly
        />
    </div>
