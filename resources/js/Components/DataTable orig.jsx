...
export default function DataTable({
            ...
            <div className="join">
                ...
                {pages.map((page) => (
                    <button
                        key={page}
                        className={`join-item btn btn-sm ${
                            page === current ? "bg-sky-600/90 text-white" : ""
                        }`}
                        onClick={() => {
    ...
    return (
        <div className="w-full p-3 border border-sky-600/90 rounded-lg">
            <form
            ...
            >
                <select
                    ...
                    className="select select-sm w-[100px] py-0 border-sky-600/90 "
                >
                    {[10, 25, 50, 100, 500, 10000].map((num) => (
                        <option key={num} value={num} className="hover:bg-sky-600/90 ">
                            Show {num}
                        </option>
                    ))}
                </select>
                ...
                {dateRangeSearch ? (
                    ...
                    <div className="flex flex-col w-full gap-2 sm:flex-row sm:items-center sm:w-auto">
                        ...
                        <input
                            ...
                            className="w-full input input-sm sm:w-auto bg-sky-100/90 input-bordered"
                        />
                        <button
                            type="submit"
                            className="px-2 btn btn-sm bg-sky-600/90 text-white btn-outline"
                        >
            ...
            {meta?.links?.length > 0 && (
                <div className="flex flex-col gap-2 mt-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="text-sm text-sky-600/90">
